...
Elm.Main.make = function (_elm) {
   ...
   ,vertical: {_: {}
              ...
              ,low: 0}},
   10);
   var Unit = F2(function (a,b) {
      return _U.insert("$class",
      a,
      b);
   });
   var Warrior = {ctor: "Warrior"};
   var Peon = {ctor: "Peon"};
   var unit = {_: {}
              ,$class: Peon
              ,boundingBox: {_: {}
                            ...
                            ,vertical: {_: {}
                                       ,high: 5
                                       ,low: 4}}};
   var updatedMap = A2($QuadTree.insert,
   unit,
   worldMap);
   var unit2 = {_: {}
               ,$class: Peon
               ,boundingBox: A4($QuadTree.boundingBox,
               95,
               98,
               95,
               98)};
   var updatededMap = A2($QuadTree.insert,
   unit2,
   updatedMap);
   var main = view(updatededMap);
...
Elm.QuadTree = Elm.QuadTree || {};
Elm.QuadTree.make = function (_elm) {
   "use strict";
   _elm.QuadTree = _elm.QuadTree || {};
   if (_elm.QuadTree.values)
   return _elm.QuadTree.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var getAllItems = function (quadTree) {
      return function () {
         switch (quadTree.ctor)
         {case "Leaf":
            return quadTree._2;
            case "Node":
            return A2($Array.append,
              A2($Array.append,
              A2($Array.append,
              getAllItems(quadTree._1),
              getAllItems(quadTree._2)),
              getAllItems(quadTree._3)),
              getAllItems(quadTree._4));}
         _U.badCase($moduleName,
         "between lines 322 and 335");
      }();
   };
   var getMaxSize = function (quadTree) {
      return function () {
         switch (quadTree.ctor)
         {case "Leaf":
            return quadTree._1;
            case "Node":
            return getMaxSize(quadTree._1);}
         _U.badCase($moduleName,
         "between lines 314 and 319");
      }();
   };
   var getBoundingBox = function (quadTree) {
      return function () {
         switch (quadTree.ctor)
         {case "Leaf":
            return quadTree._0;
   ...
   var length = function (quadTree) {
      return function () {
         switch (quadTree.ctor)
         {case "Leaf":
            return $Array.length(quadTree._2);
            case "Node":
            return length(quadTree._1) + length(quadTree._2) + length(quadTree._3) + length(quadTree._4);}
         _U.badCase($moduleName,
         "between lines 217 and 226");
      }();
   };
   var Node = F5(function (a,
   b,
   c,
   d,
   e) {
   ...
   var Leaf = F3(function (a,b,c) {
      return {ctor: "Leaf"
             ,_0: a
             ,_1: b
             ,_2: c};
   });
   var emptyQuadTree = F2(function (boundingBox,
   maxSize) {
      return A3(Leaf,
      boundingBox,
      maxSize,
   ...
   quadTree) {
      return function () {
         switch (quadTree.ctor)
         {case "Leaf": return A3(Leaf,
              quadTree._0,
              quadTree._1,
              A2($Array.map,f,quadTree._2));
            case "Node": return A5(Node,
              quadTree._0,
              A2(map,f,quadTree._1),
              A2(map,f,quadTree._2),
              A2(map,f,quadTree._3),
              A2(map,f,quadTree._4));}
         _U.badCase($moduleName,
         "between lines 391 and 402");
      }();
   });
   var Bounded = F2(function (a,
   b) {
      return _U.insert("boundingBox",
      a,
      b);
   });
   var height = function (box) {
      return box.vertical.high - box.vertical.low;
   };
   var halfHeight = function (box) {
      return height(box) / 2;
   };
   var width = function (box) {
      return box.horizontal.high - box.horizontal.low;
   };
   var halfWidth = function (box) {
      return width(box) / 2;
   };
   ...
   var BoundingBox = F2(function (a,
   b) {
      return {_: {}
             ,horizontal: a
             ,vertical: b};
   });
   var pointInInterval = F2(function (point,
   interval) {
      return _U.cmp(point,
      interval.high) < 0 && _U.cmp(point,
      interval.low) > 0;
   });
   var intersectIntervals = F2(function (interval1,
   interval2) {
      return A2(pointInInterval,
      interval1.low,
      interval2);
   });
   var intersectBoundingBoxes = F2(function (box1,
   box2) {
      return A2(intersectIntervals,
      box1.horizontal,
      box2.horizontal) && A2(intersectIntervals,
      box1.vertical,
      box2.vertical);
   });
   var findItems = F2(function (item,
   quadTree) {
      return function () {
         switch (quadTree.ctor)
         {case "Leaf":
            return A2(intersectBoundingBoxes,
              item.boundingBox,
              quadTree._0) ? quadTree._2 : $Array.empty;
            case "Node":
            return A2($Array.append,
              A2($Array.append,
              A2($Array.append,
              A2(findItems,item,quadTree._1),
              A2(findItems,item,quadTree._2)),
              A2(findItems,item,quadTree._3)),
              A2(findItems,
              item,
              quadTree._4));}
         _U.badCase($moduleName,
         "between lines 347 and 363");
      }();
   });
   ...
   var boundingBox = F4(function (minX,
   maxX,
   minY,
   maxY) {
   ...
   var subdivideNE = function (box) {
      return function () {
         var minY = box.vertical.low + halfHeight(box);
         var minX = box.horizontal.low + halfWidth(box);
         return A4(boundingBox,
         minX,
         box.horizontal.high,
         minY,
         box.vertical.high);
   ...
   var subdivideNW = function (box) {
      return function () {
         var minY = box.vertical.low + halfHeight(box);
         var maxX = box.horizontal.high - halfWidth(box);
         return A4(boundingBox,
         box.horizontal.low,
         maxX,
         minY,
   ...
   var subdivideSW = function (box) {
      return function () {
         var maxY = box.vertical.high - halfHeight(box);
         var maxX = box.horizontal.high - halfWidth(box);
         return A4(boundingBox,
         box.horizontal.low,
         maxX,
   ...
   quadTree) {
      return function () {
         ...
         {case "Leaf":
            return A2(intersectBoundingBoxes,
              item.boundingBox,
              quadTree._0) ? function () {
                 var quadTreeSE = subdivideSE(quadTree._0);
                 var quadTreeSW = subdivideSW(quadTree._0);
                 var quadTreeNW = subdivideNW(quadTree._0);
                 var quadTreeNE = subdivideNE(quadTree._0);
                 var allItems = A2($Array.push,
                 item,
                 quadTree._2);
                 var insertNew = function (quadrant) {
                    return A3($Array.foldr,
                    F2(function (item,quadTree) {
                       return A2(insert,
                       item,
                       quadTree);
                    }),
                 ...
                 return _U.cmp($Array.length(quadTree._2),
                 quadTree._1) < 0 ? A3(Leaf,
                 quadTree._0,
                 quadTree._1,
                 A2($Array.push,
                 item,
            ...
            return A2(intersectBoundingBoxes,
              ...
              quadTree._0) ? A5(Node,
              quadTree._0,
              A2(insert,item,quadTree._1),
              A2(insert,item,quadTree._2),
              A2(insert,item,quadTree._3),
              A2(insert,
              item,
              quadTree._4)) : quadTree;}
         _U.badCase($moduleName,
         "between lines 229 and 261");
      }();
   });
   var loop$ = F4(function (start,
   condition,
   update,
   $return) {
      return function () {
         var _v63 = condition(start);
         switch (_v63)
         {case false:
            return $Trampoline.Continue(function (_v64) {
                 return function () {
                    switch (_v64.ctor)
                    {case "_Tuple0":
                       return A4(loop$,
                         ...
                         $return);}
                    _U.badCase($moduleName,
                    "on line 86, column 9 to 53");
                 }();
              });
            case true:
            return $Trampoline.Done($return(start));}
         _U.badCase($moduleName,
   ...
   update,
   $return) {
      return $Trampoline.trampoline(A4(loop$,
      start,
      condition,
      update,
      $return));
   });
   var insertMany = F2(function (items,
   quadTree) {
      return function () {
         var returnFunction = function (_) {
            return _.quadTree;
         };
         var loopBody = function (_v66) {
            return function () {
               return function () {
                  var _v68 = A2($Array.get,
                  0,
                  _v66.items);
                  switch (_v68.ctor)
                  {case "Just": return {_: {}
                                       ,items: A3($Array.slice,
                                       1,
                                       $Array.length(_v66.items),
                                       _v66.items)
                                       ,quadTree: A2(insert,
                                       _v68._0,
                                       _v66.quadTree)};
                     case "Nothing": return _v66;}
                  _U.badCase($moduleName,
                  "between lines 266 and 272");
               }();
            }();
         };
         var stoppingCondition = function (_v70) {
            return function () {
   ...
   var reset = function (quadTree) {
      return A2(insertMany,
      getAllItems(quadTree),
      A2(emptyQuadTree,
      getBoundingBox(quadTree),
      getMaxSize(quadTree)));
   };
   var mapSafe = F2(function (f,
   quadTree) {
      return reset(A2(map,
      f,
      quadTree));
   });
   var flippedMap = F2(function (f,
   array) {
      return function () {
         var g = F2(function (y,x) {
            return A2(f,x,y);
         });
         return A2($Array.map,
         g(array),
   ...
   quadTree) {
      return function () {
         ...
         {case "Leaf": return A3(Leaf,
              quadTree._0,
              quadTree._1,
              A2(flippedMap,f,quadTree._2));
            case "Node": return A5(Node,
              quadTree._0,
              A2(apply,f,quadTree._1),
              A2(apply,f,quadTree._2),
              A2(apply,f,quadTree._3),
              A2(apply,f,quadTree._4));}
         _U.badCase($moduleName,
         "between lines 366 and 376");
      }();
   });
   var applySafe = F2(function (f,
   quadTree) {
      return reset(A2(apply,
      f,
      quadTree));
   });
   ...
   quadTree) {
      return function () {
         ...
         {case "Leaf": return A3(Leaf,
              ...
              A2(dropIf,
              function (it) {
                 return _U.eq(it,item);
              },
              quadTree._2));
            case "Node": return A5(Node,
              quadTree._0,
              A2(remove,item,quadTree._1),
              A2(remove,item,quadTree._2),
              A2(remove,item,quadTree._3),
              A2(remove,item,quadTree._4));}
         _U.badCase($moduleName,
         "between lines 285 and 297");
      }();
   });
   var update = F3(function (updateFunction,
   item,
   quadTree) {
      return A2(insert,
      updateFunction(item),
      A2(remove,item,quadTree));
   });
   _elm.QuadTree.values = {_op: _op
                          ...
                          ,center: center
                          ,intersectBoundingBoxes: intersectBoundingBoxes
